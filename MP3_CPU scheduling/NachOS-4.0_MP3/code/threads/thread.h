...
// while executing kernel code.
  ...
  //     for MP3, thread data structures    //
  public:
    int thread_priority;
    double approximate_burst_time;
    double remain_app_burst_time;
    int burst_time;
    int start_time;
    int thread_age;
    int waiting_time;
    int start_waiting_time;
    void Approximate_Next_Burst_Time();   // done
    void Update_Burst_Time();    // done
    void Set_Start_Time();    // done
    void Reset_Burst_Time();   // done
    void aging();
};
